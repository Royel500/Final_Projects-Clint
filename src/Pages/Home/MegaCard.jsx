...
const MegaCard = () => {
  return (
    <div className="bg-[#003b3d] mx-5 rounded-2xl text-white px-8 py-10 md:flex items-center justify-between shadow-lg overflow-hidden">
      {/* Left Content */}
      <div className="md:w-1/2 space-y-4">
       ...
       <button className="border border-[#c7f464] text-[#c7f464]
           font-semibold px-5 py-2 rounded-full hover:bg-[#c7f464] hover:text-black transition">
            Become a Merchant
          </button>
