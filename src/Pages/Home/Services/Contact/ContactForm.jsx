...
const ContactForm = () => {
  ...
  return (
    <div className="bg-base-300 p-8 rounded-xl font-bold border shadow-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2 border border-black-300 rounded-md
        ...
        <button
          type="submit"
          className="flex items-center justify-center w-full bg-green-400 py-3 px-4 
